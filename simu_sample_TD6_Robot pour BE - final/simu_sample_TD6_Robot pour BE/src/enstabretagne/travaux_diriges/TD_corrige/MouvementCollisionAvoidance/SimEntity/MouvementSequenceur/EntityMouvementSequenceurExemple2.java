...
public class EntityMouvementSequenceurExemple2 extends EntityMouvementSequenceur{

	EntityMouvementSequenceurFeature emsf;
	EntityMouvementSequenceurInit emsi;
	
	public EntityMouvementSequenceurExemple2(String name, SimFeatures features) {
		super(name, features);
	}
